...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <button class="btn btn-success btn-sm" onclick="$('#roundTable').DataTable().button('.buttons-excel').trigger()">Excel</button>
            <button class="btn btn-danger btn-sm" onclick="$('#roundTable').DataTable().button('.buttons-pdf').trigger()">PDF</button>
