...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="{{ route('clinical-sessions.export.excel') }}" class="btn btn-success btn-sm">Excel</a>
            <a href="{{ route('clinical-sessions.export.pdf') }}" class="btn btn-danger btn-sm">PDF</a>
                ...
                <tbody>
                    @forelse($rounds as $i => $r)
                        <tr>
                            ...
                            <td>
                                @if(!$r->to_time)
                                <a href="{{ route('clinical-sessions.end',$r) }}" onclick="return confirm('End activity?')" class="btn btn-danger btn-sm">End activity</a>
                                @else
                                {{ $r->to_time }}
                                @endif
                            </td>
...
{{-- ADD Clinic Sessions  MODAL --}}
<div class="modal fade" id="addRoundModal" tabindex="-1">
    <div class="modal-dialog">
        <form method="POST" action="{{ route('clinical-sessions.store') }}" class="modal-content">
            @csrf
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title">Add Clinic Sessions</h5>
...
{{-- Clinic Sessions PERFORMANCE MODAL --}}
...
function loadData(period){
    ...
    fetch(`{{ route('clinical-sessions.performance') }}?period=${period}`)
    .then(r=>r.json())
    .then(res=>{
